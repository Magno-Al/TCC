...
O \textit{display} Waveshare de 7 polegadas se destacou devido ao tamanho da tela — garantindo alta legibilidade e usabilidade à beira do leito —, à compatibilidade direta via interface HDMI com a placa de processamento escolhida e ao suporte a toque capacitivo, que possibilita uma interação mais responsiva com a interface gráfica.
